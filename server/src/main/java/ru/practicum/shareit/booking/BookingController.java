...
public class BookingController {
	...
	public ResponseEntity<BookingDto> createBooking(
			...
			@RequestBody BookingDtoLite bookingDto) {
	...
	public ResponseEntity<List<BookingDto>> getItemBookings(
		...
		return ResponseEntity.ok(service.getBookingsByItem(itemId,
	...
	public ResponseEntity<List<BookingDto>> getOwnerBookings(
		...
		return ResponseEntity.ok(service.getBookingsByOwner(userId, state,
				PageRequest.of((from / size), size)));
	}
	...
	public ResponseEntity<List<BookingDto>> getUserBookings(
		...
		return ResponseEntity.ok(service.getBookingsByBooker(userId, state,
				PageRequest.of((from / size), size)));
	}
